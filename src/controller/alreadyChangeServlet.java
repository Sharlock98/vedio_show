...
@WebServlet(name = "alreadyChangeServlet",urlPatterns = "/alreadychange")
@MultipartConfig()
public class alreadyChangeServlet extends HttpServlet {
    ...
    protected void doGet(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
        ...
        if (species.equals("电影")){
            String name=request.getParameter("mingcheng");
