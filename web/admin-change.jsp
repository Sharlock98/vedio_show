...
<div class="admin-zhu">
    ...
    <div class="container">
        <div class="col-lg-12">
            ...
            <form class="form-horizontal" method="post" action="alreadychange" enctype="multipart/form-data">
                <div class="col-lg-4">
                    ...
                    <div class="form-group form-group-sm">
                        ...
                        <div class="col-lg-3">
                            <input style="border-radius: 0px 2px 2px 2px" class="file" name="image" size="690x966"  rate="0.2" type="text" value="<%=list.get(0).getImage()%>" />
                    ...
                    <div class="form-group form-group-sm">
                        ...
                        <input style="border-radius: 0 2px 2px 0;width: 265px;height: 30px" class="form-control input-lg" type="text" name="mingcheng" value="<%=list.get(0).getMingcheng()%>" placeholder="请输入1-15个字符" />
                    </div>
                </div>
                ...
                <div class="col-lg-6">
                    <div class="form-group form-group-sm">
                        ...
                        <input style="border-radius: 0 2px 2px 0;height: 30px" class="form-control input-lg" type="text" name="daoyan" value="<%=list.get(0).getDaoyan()%>" placeholder="请输入1-20个字符" />
                    </div>

                    <div class="form-group form-group-sm">
                        <label class="control-label col-md-1">主演</label>
                        <input style="border-radius: 0 2px 2px 0;height: 30px" class="form-control input-lg" type="text" name="zhuyan" value="<%=list.get(0).getZhuyan()%>" placeholder="格式：XX/XX/XX/ (1-15字符)" />
                    </div>

                    <div class="form-group form-group-sm">
                        <label class="control-label col-md-1">类型</label>
                        <input style="border-radius: 0 2px 2px 0;height: 30px" class="form-control input-lg" type="text" name="leixing" value="<%=list.get(0).getLeixing()%>" placeholder="格式：XX/XX/XX/ (1-15字符)" />
                    </div>

                    <div class="form-group form-group-sm">
                        <label class="control-label col-md-1">制片国家</label>
                        <input style="border-radius: 0 2px 2px 0;height: 30px" class="form-control input-lg" type="text" name="guojia" value="<%=list.get(0).getGuojia()%>" placeholder="请输入1-10个字符" />
                    </div>

                    <div class="form-group form-group-sm">
                        <label class="control-label col-md-1">上映日期</label>
                        <input style="border-radius: 0 2px 2px 0;height: 30px" class="form-control input-lg" type="text" name="shijian" value="<%=list.get(0).getShijian()%>" placeholder="格式：XXXX-XX-XX" />
                    </div>

                    <div class="form-group form-group-sm">
                        <label class="control-label col-md-1">剧情简介</label>
                        <textarea style="border-radius: 0 2px 2px 0;width: 400px;" class="form-control" rows="5" name="jieshao" placeholder="请输入1-150个字符"><%=list.get(0).getJieshao()%></textarea>
                    </div>
                    <div class="form-group form-group-sm">
                        <label class="control-label col-md-1">视频地址</label>
                        <input style="border-radius: 0 2px 2px 0;height: 30px" class="form-control input-lg" type="text" name="pianyuan" value="<%=list.get(0).getPianyuan()%>" />
                    </div>
                    ...
                    <div class="btn-group">
                        ...
                        <button style="width:200px" type="submit" class="btn btn-danger btn-sm" title="修改"><i class="glyphicon glyphicon-floppy-save"></i>修改</button>
                    </div>
